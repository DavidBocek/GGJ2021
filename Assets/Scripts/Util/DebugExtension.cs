...
public static class DebugExtension
{
	...
	public static void DrawCylinder(Vector3 start, Vector3 end, Color color, float radius = 1, float duration = 0, bool depthTest = true)
	{
		...
		//Radial circles
		DebugExtension.DrawCircle(start, up, color, radius, duration, depthTest);	
		DebugExtension.DrawCircle(end, -up, color, radius, duration, depthTest);
		DebugExtension.DrawCircle((start+end)*0.5f, up, color, radius, duration, depthTest);
	...
	public static void DrawCone(Vector3 position, Vector3 direction, Color color, float angle = 45, float duration = 0, bool depthTest = true)
	{
		...
		DebugExtension.DrawCircle(position+_forward, direction, color, (_forward-(slerpedVector.normalized*dist)).magnitude, duration, depthTest);
		DebugExtension.DrawCircle(position+(_forward*0.5f), direction, color, ((_forward*0.5f)-(slerpedVector.normalized*(dist*0.5f))).magnitude, duration, depthTest);
	}
	...
	public static void DrawArrow(Vector3 position, Vector3 direction, Color color, float duration = 0, bool depthTest = true)
	{
		...
		DebugExtension.DrawCone(position+direction, -direction*0.2f, color, 8f, duration, depthTest);
	}
	...
	/// </param>
	public static void GizmoDrawPoint(Vector3 position, Color color, float scale = 1.0f)
	{
	...
	/// 	- The size of the drawn point.
	/// </param>
	public static void GizmoDrawPoint(Vector3 position, float scale = 1.0f)
	{
		GizmoDrawPoint(position, Color.white, scale);
	}
	...
	/// 	- The color of the bounds.
	/// </param>
	public static void GizmoDrawBounds(Bounds bounds, Color color)
	{
		Vector3 center = bounds.center;
	...
	/// 	- The bounds to draw.
	/// </param>
	public static void GizmoDrawBounds(Bounds bounds)
	{
		GizmoDrawBounds(bounds, Color.white);
	}
	...
	/// </param>
	public static void GizmoDrawLocalCube(Transform transform, Vector3 size, Color color, Vector3 center = default(Vector3))
	{
		Color oldColor = Gizmos.color;
		Gizmos.color = color;
	...
	///		- The local position of the cube.
	/// </param>	
	public static void GizmoDrawLocalCube(Transform transform, Vector3 size, Vector3 center = default(Vector3))
	{
		GizmoDrawLocalCube(transform, size, Color.white, center);
	}
	...
	/// 	- The color of the cube.
	/// </param>
	public static void GizmoDrawLocalCube(Matrix4x4 space, Vector3 size, Color color, Vector3 center = default(Vector3))
	{
		Color oldColor = Gizmos.color;
		Gizmos.color = color;
	...
	/// 	- The local position of the cube.
	/// </param>
	public static void GizmoDrawLocalCube(Matrix4x4 space, Vector3 size, Vector3 center = default(Vector3))
	{
		GizmoDrawLocalCube(space, size, Color.white, center);
	}
	...
	/// 	- The radius of the cylinder.
	/// </param>
	public static void GizmoDrawCylinder(Vector3 start, Vector3 end, Color color, float radius = 1.0f){
		Vector3 up = (end-start).normalized*radius;
		Vector3 forward = Vector3.Slerp(up, -up, 0.5f);
		Vector3 right = Vector3.Cross(up, forward).normalized*radius;
	...
	/// 	- The radius of the cylinder.
	/// </param>
	public static void GizmoDrawCylinder(Vector3 start, Vector3 end, float radius = 1.0f)
	{
		GizmoDrawCylinder(start, end, Color.white, radius);
	}
	...
	/// 	- The angle of the cone.
	/// </param>
	public static void GizmoDrawCone(Vector3 position, Vector3 direction, Color color, float angle = 45)
	{
		float length = direction.magnitude;
	...
	/// 	- The angle of the cone.
	/// </param>
	public static void GizmoDrawCone(Vector3 position, Vector3 direction, float angle = 45)
	{
		GizmoDrawCone(position, direction, Color.white, angle);
	}
	...
	/// 	- The angle of the cone.
	/// </param>
	public static void GizmoDrawCone(Vector3 position, Color color, float angle = 45)
	{
		GizmoDrawCone(position, Vector3.up, color, angle);
	}
	...
	/// 	- The angle of the cone.
	/// </param>
	public static void GizmoDrawCone(Vector3 position, float angle = 45)
	{
		GizmoDrawCone(position, Vector3.up, Color.white, angle);
	}
	...
	{	
		...
		DebugExtension.GizmoDrawCone(position+direction, -direction*0.333f, color, 15);
	...
	/// 	- The radius of the capsule.
	/// </param>
	public static void GizmoDrawCapsule(Vector3 start, Vector3 end, Color color, float radius = 1)
	{
		Vector3 up = (end-start).normalized*radius;
		Vector3 forward = Vector3.Slerp(up, -up, 0.5f);
		Vector3 right = Vector3.Cross(up, forward).normalized*radius;
	...
	/// 	- The radius of the capsule.
	/// </param>
	public static void GizmoDrawCapsule(Vector3 start, Vector3 end, float radius = 1)
	{
		GizmoDrawCapsule(start, end, Color.white, radius);
	}
